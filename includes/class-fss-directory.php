...
class Fss_Directory {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Fss_Directory_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'FSS_DIRECTORY_VERSION' ) ) {
			$this->version = FSS_DIRECTORY_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'fss-directory';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Fss_Directory_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Fss_Directory_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Fss_Directory_Loader    Orchestrates the hooks of the plugin.
	 */
